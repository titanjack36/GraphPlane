...
public class FunctionConstructor {
    ...
    public Function toFunction(String funcStr) throws
    ...
    public Function toFunctionDebug(String funcStr) throws
            InvalidExpressionException {
        DEBUG = true;
        DEBUG_indices = false;
    ...
    private Function toFunction(String funcStr, String DEBUG_spacing) throws
            InvalidExpressionException{
        ...
        if (funcStr.length() == 1 && !eqlsAny(funcStr.charAt(0),
            ...
            throw new InvalidExpressionException("Expression has invalid " +
                    "characters");
        }
        ...
        throw new InvalidExpressionException("The parser is unable to handle " +
                "this expression");
    }
                ...
                if (type.equals("sum")) {
                    ...
                    if (i < str.length() - 1) {
                        ...
                        if (str.charAt(i) == 'x' || eqlsClosedBrackets(
                                str.charAt(i))) {
                            if (eqlsOpenBrackets(nextChr) || isLetter(nextChr)
                                    || isNum(nextChr))
                                indices.add(i);
                        }
                    }
    ...
    private void assertHasMatchingBrackets(String str) throws
            InvalidExpressionException {
        if (!hasMatchingBrackets(str)) {
            throw new InvalidExpressionException("Expression does not " +
    ...
    private double toNumberDouble(String str) throws
            InvalidExpressionException {
        double num;
        try {
            num = Double.parseDouble(str);
        } catch (NumberFormatException e) {
            throw new InvalidExpressionException("The number in the string " +
                    "is invalid");
        }
        return num;
    }
    ...
    private String replaceOccurrences(String str, String find, String replace) {
        ...
        return str.charAt(0) + replaceOccurrences(str.substring(1), find, replace);
    }
}
